...
class CoordinatesGenerator:
    ...
    def __mouse_callback(self, event, x, y, flags, params):
        ...
        self.image = open_cv.putText(self.image, 'Press Q to Quit', (580,50), open_cv.FONT_HERSHEY_SIMPLEX,1, (255,0,0), 1, open_cv.LINE_AA)
        open_cv.imshow(self.caption, self.image)
    ...
    def __handle_done(self):
        ...
        draw_contours(self.image, coordinates-1, str(self.ids + 1), COLOR_WHITE)
        for i in range(0, 4):
